...
class TestConvertersCases(unittest.TestCase):
    """Test cases for converters module."""

    def test_str_to_int___success(self):
        """Test str to int conversion works appropriately."""
    ...
    def test_str_to_int___failed(self):
        """Test str to int conversion returns none with invalid arguments."""
    ...
    def test_int_to_str__success(self):
        """Test int to str conversion works appropriately."""
